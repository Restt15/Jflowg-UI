        ...
        <div className="space-x-4">
          {links.map((link, index) => (
            <NavLink 
              ...
              className="text-lg text-white font-semibold px-5 py-2 border-2 border-blue-900 bg-blue-800 rounded-md transition duration-500 ease-in-out transform hover:translante-y-1 hover:scale-110 
