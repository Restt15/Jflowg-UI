...
const Harticles = ({ addToCart, }) => {
  ...
  <section className="px-4 sm:px-6 lg:px-8 py-8 flex flex-col sm:flex-row items-start justify-between">
    <div className="flex flex-col w-full sm:w-2/3">
      <div className="w-full max-w-md p-4 shadow-lg border rounded-lg bg-white mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Filtrar por Precio</h2>
        <div className="flex gap-2">
            <Radio onClick={() => setFoods(products)} name="type" label="Todo"></Radio>
            <Radio onClick={() => filterPrice(35.00)} name="type" label="35"></Radio>
            <Radio onClick={() => filterPrice(40.00)} name="type" label="40"></Radio>
          </div>
        <hr className="my-6" />
        <div className="mb-4">
  ...
  >
    <div className="flex items-center justify-between w-full">
      <Typography variant="h6" className="text-sm">Todo</Typography>
  ...
  >
    <div className="flex items-center justify-between w-full">
      <Typography variant="h6" className="text-sm" >Ropa</Typography>
  ...
  >
    <div className="flex items-center justify-between w-full">
      <Typography variant="h6" className="text-sm">Zapatillas</Typography>
      <span className="inline-flex items-center justify-center bg-black text-white font-semibold text-sm px-3 py-1 rounded-full transition duration-300 ease-in-out hover:bg-gray-700 hover:text-white">
  ...
  >
    <div className="flex items-center justify-between w-full">
      <Typography variant="h6"className="text-sm">Accesorios</Typography>
  ...
  <a href={`/Harticles/Details/${item.id}`}>
    <div className="relative overflow-hidden group">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100">
        <span className="text-white text-xl font-bold">Ver Detalles</span>
      </div>
    </div>
    <CardBody className="p-4">
      <Typography className="text-lg font-semibold text-black mb-2">{item.title}</Typography>
      <Typography className="text-gray-800 mb-2">{item.description}</Typography>
      <Typography className="text-blue-900">${item.price}</Typography>
    </CardBody>
  </a>
  <CardFooter>
    <Button
