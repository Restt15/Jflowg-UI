    ...
    {cart.length === 0 ? (
      <div className="text-center mt-8 p-4 bg-gray-100 border border-gray-200 rounded-md text-black">
        ...
        <div className="flex flex-col w-full sm:w-2/3">
          <article>
            {cart.map((item, index) => (
              <Card key={index} className="mb-8 border-2 border-x-green-400  rounded-md overflow-hidden shadow-lg ">
        ...
        <aside className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 mt-10 sm:mt-0 sticky top-0">
          <Card className="h-40 w-full sm:w-80 ml-auto">
